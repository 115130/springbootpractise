...
import com.example.android.domain.LateReturnTableExample.Criteria;
import com.example.android.domain.LateReturnTableExample.Criterion;
import com.example.android.domain.LateReturnTableExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class LateReturnTableSqlProvider {
    public String countByExample(LateReturnTableExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("late_return_table");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(LateReturnTableExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("late_return_table");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(LateReturnTable record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("late_return_table");
    ...
    public String selectByExample(LateReturnTableExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        LateReturnTable record = (LateReturnTable) parameter.get("record");
        LateReturnTableExample example = (LateReturnTableExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("late_return_table");
    ...
    public String updateByPrimaryKeySelective(LateReturnTable record) {
        SQL sql = new SQL();
        sql.UPDATE("late_return_table");
    ...
    protected void applyWhere(SQL sql, LateReturnTableExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
